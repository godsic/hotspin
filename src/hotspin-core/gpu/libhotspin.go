...
func Add(dst, a, b *Array) {
	...
	C.addAsync(
		(*C.float)(unsafe.Pointer((dst.pointer))),
		(*C.float)(unsafe.Pointer((a.pointer))),
		(*C.float)(unsafe.Pointer((b.pointer))),
		(C.CUstream)(unsafe.Pointer((dst.Stream))),
		C.int(dst.partLen4D))
	dst.Stream.Sync()
}
...
func DivMulPow(dst, a, b, c *Array, p float64) {
	...
	C.divMulPowAsync(
		...
		(*C.float)(unsafe.Pointer((a.pointer))),
		(*C.float)(unsafe.Pointer((b.pointer))),
		(*C.float)(unsafe.Pointer((c.pointer))),
		C.float(float32(p)),
...
func DotMask(dst, a, b *Array, aMul, bMul []float64) {
	...
	C.dotMaskAsync(
		(*C.float)(unsafe.Pointer((dst.Comp[X].pointer))),

		(*C.float)(unsafe.Pointer((a.Comp[X].pointer))),
		(*C.float)(unsafe.Pointer((a.Comp[Y].pointer))),
		(*C.float)(unsafe.Pointer((a.Comp[Z].pointer))),

		(*C.float)(unsafe.Pointer((b.Comp[X].pointer))),
		(*C.float)(unsafe.Pointer((b.Comp[Y].pointer))),
		(*C.float)(unsafe.Pointer((b.Comp[Z].pointer))),
...
func DotSign(dst, a, b, c *Array) {
	...
	C.dotSignAsync(
		...
		(*C.float)(unsafe.Pointer((c.Comp[X].pointer))),
		(*C.float)(unsafe.Pointer((c.Comp[Y].pointer))),
		(*C.float)(unsafe.Pointer((c.Comp[Z].pointer))),
...
func VecMadd(dst, a, b *Array, mulB []float64) {
	C.vecMaddAsync(
		(*C.float)(unsafe.Pointer((dst.Comp[X].pointer))),
		(*C.float)(unsafe.Pointer((dst.Comp[Y].pointer))),
		(*C.float)(unsafe.Pointer((dst.Comp[Z].pointer))),
...
func CMaddAsync(dst *Array, scale complex64, kern, src *Array, stream Stream) {
	...
	C.cmaddAsync(
		...
		(C.float)(real(scale)),
		(C.float)(imag(scale)),
		(*C.float)(unsafe.Pointer((kern.pointer))),
		(*C.float)(unsafe.Pointer((src.pointer))),
		(C.CUstream)(unsafe.Pointer((stream))),
...
func WeightedAverage(dst, x0, x1, w0, w1, R *Array, w0Mul, w1Mul, RMul float64) {
	...
	C.wavgAsync(
		(*C.float)(unsafe.Pointer((dst.pointer))),
		(*C.float)(unsafe.Pointer((x0.pointer))),
		(*C.float)(unsafe.Pointer((x1.pointer))),
		(*C.float)(unsafe.Pointer((w0.pointer))),
		(*C.float)(unsafe.Pointer((w1.pointer))),
		(*C.float)(unsafe.Pointer((R.pointer))),
...
func Normalize(m *Array) {
	C.normalizeAsync(
		...
		(C.CUstream)(unsafe.Pointer((m.Stream))),
		C.int(m.partLen3D))
	m.Stream.Sync()
}
...
func Decompose(Mf *Array, m *Array, msat *Array, msatMul float32) {
	C.decomposeAsync(
		(*C.float)(unsafe.Pointer((Mf.Comp[X].pointer))),
		(*C.float)(unsafe.Pointer((Mf.Comp[Y].pointer))),
		(*C.float)(unsafe.Pointer((Mf.Comp[Z].pointer))),

		(*C.float)(unsafe.Pointer((m.Comp[X].pointer))),
		(*C.float)(unsafe.Pointer((m.Comp[Y].pointer))),
		(*C.float)(unsafe.Pointer((m.Comp[Z].pointer))),

		(*C.float)(unsafe.Pointer((msat.pointer))),
...
func PartialSum(in, out *Array, blocks, threadsPerBlock, N int) {
	C.partialSumAsync(
		(*C.float)(unsafe.Pointer(in.pointer)),
		(*C.float)(unsafe.Pointer(out.pointer)),
		C.int(blocks),
		C.int(threadsPerBlock),
		C.int(N),
		(C.CUstream)(unsafe.Pointer((out.Stream))))
	out.Stream.Sync()
}
...
func PartialSDot(in1, in2, out *Array, blocks, threadsPerBlock, N int) {
	C.partialSDotAsync(
		(*C.float)(unsafe.Pointer(in1.pointer)),
		(*C.float)(unsafe.Pointer(in2.pointer)),
		(*C.float)(unsafe.Pointer(out.pointer)),
		C.int(blocks),
		C.int(threadsPerBlock),
		C.int(N),
...
func PartialMaxNorm3Sq(x, y, z, out *Array, blocks, threadsPerBlock, N int) {
	C.partialMaxNorm3SqAsync(
		(*C.float)(unsafe.Pointer(x.pointer)),
		(*C.float)(unsafe.Pointer(y.pointer)),
		(*C.float)(unsafe.Pointer(z.pointer)),
		(*C.float)(unsafe.Pointer(out.pointer)),
		C.int(blocks),
		C.int(threadsPerBlock),
		C.int(N),
...
func PartialMaxNorm3SqDiff(x1, y1, z1, x2, y2, z2, out *Array, blocks, threadsPerBlock, N int) {
	C.partialMaxNorm3SqDiffAsync(
		(*C.float)(unsafe.Pointer(x1.pointer)),
		(*C.float)(unsafe.Pointer(y1.pointer)),
		(*C.float)(unsafe.Pointer(z1.pointer)),
		(*C.float)(unsafe.Pointer(x2.pointer)),
		(*C.float)(unsafe.Pointer(y2.pointer)),
		(*C.float)(unsafe.Pointer(z2.pointer)),
		(*C.float)(unsafe.Pointer(out.pointer)),
		C.int(blocks),
		C.int(threadsPerBlock),
		C.int(N),
...
func UniaxialAnisotropyAsync(h, m *Array, KuMask, MsatMask *Array, Ku2_Mu0MSat float64, anisUMask *Array, anisUMul []float64, stream Stream) {
	C.uniaxialAnisotropyAsync(
		...
		(*C.float)(unsafe.Pointer((m.Comp[Y].pointer))),
		(*C.float)(unsafe.Pointer((m.Comp[Z].pointer))),
		(*C.float)(unsafe.Pointer((KuMask.pointer))),
		(*C.float)(unsafe.Pointer((MsatMask.pointer))),
		(C.float)(Ku2_Mu0MSat),
		(*C.float)(unsafe.Pointer((anisUMask.Comp[X].pointer))),
		(C.float)(anisUMul[X]),
		(*C.float)(unsafe.Pointer((anisUMask.Comp[Y].pointer))),
		(C.float)(anisUMul[Y]),
		(*C.float)(unsafe.Pointer((anisUMask.Comp[Z].pointer))),
		(C.float)(anisUMul[Z]),
		(C.CUstream)(unsafe.Pointer((stream))),
		(C.int)(h.partLen3D))
}
...
func Exchange6Async(h, mf, msat0T0, lex *Array, lexMul2Msat0T0Mul_cellSize2 []float64, periodic []int, stream Stream) {
	...
	C.exchange6Async(
		...
		(*C.float)(unsafe.Pointer((lex.Comp[X].pointer))),
		(C.int)(h.PartSize()[X]),
		(C.int)(h.PartSize()[Y]),
		(C.int)(h.PartSize()[Z]),
		(C.int)(periodic[X]),
