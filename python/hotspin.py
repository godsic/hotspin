...
#  E.g. remove(handle) stops auto-saving it.
#  @see filenumberfomat
def autosavesinglefile(quantity, format, options, period ):
	ret = call("autosavesinglefile", [quantity, format, options, period])
	return int(ret[0])
...
def getdispersion(fmin, fmax, steps, format ):
	ret = call("getdispersion", [fmin, fmax, steps, format])
	return 
...
def getscalar(quantity ):
	ret = call("getscalar", [quantity])
	return float(ret[0])
...
def setpointwise(quantity, time, value ):
	ret = call("setpointwise", [quantity, time, value])
	return 

def setpointwiseof(argument, quantity, arg, value ):
	ret = call("setpointwiseof", [argument, quantity, arg, value])
	return 
...
def setscalar(quantity, value ):
	ret = call("setscalar", [quantity, value])
	return 
...
def setvalue(quantity, value ):
	ret = call("setvalue", [quantity, value])
	return 
